...
<head>
  ...
  <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/styles.css" media="screen"/>
          ...
          <ul>
            ...
            if($nav && ($navs=$nav->getNavLinks()) && is_array($navs)){
              foreach($navs as $name =>$nav) {
                echo sprintf('
                <li><a class="%s %s" href="%s">%s</a>
                </li>%s',$nav['active']?'active':'',$name,(ROOT_PATH.$nav['href']),$nav['desc'],"\n");
                }
            } ?>
          </ul>
        <?php
